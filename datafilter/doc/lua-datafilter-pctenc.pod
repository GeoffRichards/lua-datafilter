...
C<percent_encode> will escape certain any bytes in the input which it
...
and lowercase letters, digits, and the characters S<hyphen (C<->)>,
S<fullstop (C<.>)>, S<underscore (C<_>)>, and S<tilde (C<~>)>.
